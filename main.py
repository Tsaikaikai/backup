...
class Aging_detect():
    ...
    def Result_Output(self):
        ...
        for i in range(len(self.judge_detail)):
            ...
            # 超過75%沒有pattern亮起，代表從頭到尾都沒亮過->可能沒放，可能放壞的
            # 寫no pattern 佛哥比較好認，不一定要寫No pattern
            
            if self.judge_detail[i]["judge_detail"]["Not_Found"]["cnt"] > len(self.file_list) * 0.75:
                result = "NO Pattern" 
            else:
...
if __name__ == '__main__':
    ...
    path = "dataset/123456_ABCDEFG/NG_test"
